...
torch.save(discard_model.state_dict(), r"G:\マイドライブ\MahjongAI\discard_best.pth")
torch.save(call_model.state_dict(), r"G:\マイドライブ\MahjongAI\call_best.pth")
torch.save(riichi_model.state_dict(), r"G:\マイドライブ\MahjongAI\riichi_best.pth")
torch.save(oshibiki_model.state_dict(), r"G:\マイドライブ\MahjongAI\oshibiki_best.pth")
