# run_train_naki_34ch.py
# 鳴き判断モデル (3クラス: 0=スルー, 1=ポン, 2=チー) の学習スクリプト
# 入力: dataset_naki_33ch.pkl (34ch tensor, label 0/1/2)
# 出力: naki_34ch_best.pth
...
# 設定
# ============================================================
DATASET_PATH = r"G:\マイドライブ\MahjongAI\dataset_naki_33ch.pkl"
SAVE_PATH    = r"G:\マイドライブ\MahjongAI\naki_34ch_best.pth"
LOCAL_SAVE   = rr"G:\マイドライブ\MahjongAI\naki_34ch_best.pth"

NUM_CLASSES  = 3   # 0=スルー, 1=ポン, 2=チー
NUM_EPOCHS   = 30
BATCH_SIZE   = 512
LR           = 3e-4
WEIGHT_DECAY = 1e-4
...
class NakiDataset(Dataset):
    ...
    def __getitem__(self, idx):
        x = torch.tensor(self.tensors[idx], dtype=torch.float32)  # (34, 34)
...
# game ID で train/val 分割 (データリーク防止)
...
train_ds = NakiDataset(train_records)
val_ds   = NakiDataset(val_records)
