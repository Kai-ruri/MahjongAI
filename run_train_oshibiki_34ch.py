# run_train_oshibiki_34ch.py
# 押し引き判断モデル (2クラス: 0=安全牌, 1=危険押し) の学習スクリプト
# 入力: dataset_oshibiki_33ch.pkl (34ch tensor, label 0/1)
# 出力: oshibiki_34ch_best.pth
...
# 設定
# ============================================================
DATASET_PATH = r"G:\マイドライブ\MahjongAI\dataset_oshibiki_v2.pkl"
SAVE_PATH    = r"G:\マイドライブ\MahjongAI\oshibiki_34ch_best.pth"
LOCAL_SAVE   = rr"G:\マイドライブ\MahjongAI\oshibiki_34ch_best.pth"

NUM_CLASSES  = 2   # 0=安全牌(現物etc), 1=危険牌押し
NUM_EPOCHS   = 30
BATCH_SIZE   = 512
LR           = 3e-4
WEIGHT_DECAY = 1e-4
...
train_ds = OshibikiDataset(train_records)
val_ds   = OshibikiDataset(val_records)
...
model = MahjongResNet_34ch(num_classes=NUM_CLASSES, in_channels=33, num_blocks=3, channels=128,
